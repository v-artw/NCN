#!/usr/bin/env python3
"""Evaluate read-only MKF T+1..T+10 close-to-close profitability."""
...
from ashare_edge_scout.pmkf_mkf.profitability import build_profitability_panel, build_profitability_report
...
def _stock(task: tuple[str, dict[str, Any], str, str | None]) -> pd.DataFrame:
    ...
    return build_profitability_panel(path.stem, frame, config, start_date=start_date, end_date=end_date)
