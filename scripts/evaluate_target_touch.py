#!/usr/bin/env python3
"""Evaluate full-universe T-open plus-3% five-day target-touch win rate."""
...
from ashare_edge_scout.research_target_touch import build_report, build_target_touch_panel
...
def _stock(task: tuple[str, dict[str, Any], str, str | None]) -> pd.DataFrame:
    ...
    return build_target_touch_panel(path.stem, frame, config, start_date=start_date, end_date=end_date)
