#!/usr/bin/env python3
"""Evaluate local PMKF/MKF T+5 candidate quality comparison."""
...
from ashare_edge_scout.research_pmkf_mkf_t5_quality import build_comparison_panel, build_comparison_report
...
def _stock(task: tuple[str, dict[str, Any], str, str | None]) -> pd.DataFrame:
    ...
    return build_comparison_panel(path.stem, frame, config, start_date=start_date, end_date=end_date)
