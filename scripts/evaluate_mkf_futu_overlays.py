#!/usr/bin/env python3
"""Evaluate four preregistered same-day Futu overlays on unchanged MKF v3."""
...
from ashare_edge_scout.pmkf_mkf.mkf_futu_overlay_study import build_overlay_panel, build_overlay_report
...
def _stock(task: tuple[str, dict[str, Any], str, str | None]) -> pd.DataFrame:
    ...
    return build_overlay_panel(path.stem, frame, config, start_date=start_date, end_date=end_date)
